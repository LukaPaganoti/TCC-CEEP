    ...
    <table class="table table-striped table-bordered">
        ...
        <?php foreach ($resultado as $r) { ?>
            <tr>
                ...
                <td><a href="alterarcliente.php?id=<?php echo $r['codcliente'] ?>" class="btn btn-warning"> ALTERAÇÃO</a> - <a href="excluircliente.php?id=<?php echo $r['codcliente'] ?>" class="btn btn-danger">EXCLUSÃO</a> </td>
            </tr>
