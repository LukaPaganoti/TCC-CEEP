...
if (isset($_POST['btncadastroendereco'])) {
    ...
    if (empty($ruaend) || empty($cepend) || empty($numeroend) || empty($bairroend)) {
        ...
        $sql = "INSERT INTO tb_enderecos (ruaend, cepend, numeroend, bairroend, complementoend, fk_codcidade) VALUES (:ruaend, :cepend, :numeroend, :bairroend, :complementoend, :fk_codcidade)";
