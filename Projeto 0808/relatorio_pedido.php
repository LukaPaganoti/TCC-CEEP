...
// Verificar se há um pedido recente
...
$sql_pedido = "SELECT * FROM tb_pedidos WHERE codpedido = :codpedido AND fk_codcliente = :codcliente";
$stmt_pedido = $pdo->prepare($sql_pedido);
$stmt_pedido->bindParam(':codpedido', $codpedido);
$stmt_pedido->bindParam(':codcliente', $codcliente);
$stmt_pedido->execute();
...
<script>
    function redirectToProfile() {
        window.location.href = 'perfil.php';
                        ...
                        <a href="relatorio_pedido.php">Minhas Compras</a>
...
<body>
    ...
    <p>Número do Pedido: <?php echo $codpedido; ?></p>
    <p>Cliente: <?php echo $cliente['nomecli']; ?></p>
...
<p>Total do Pedido: R$ <?php echo number_format($pedido['totalpedido'], 2, ',', '.'); ?></p>
