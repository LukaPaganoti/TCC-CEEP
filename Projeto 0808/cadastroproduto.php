...
if (isset($_POST['btncadastrarproduto'])) {
    ...
    if (empty($fk_codcategoria)) {
            echo "É necessário informar a categoria do produto";
            exit();
    }

    // Criar a consulta SQL de inserção
    $sqlc = "INSERT INTO tb_produtos (nomeprod, precoprod, tamanhoprod, pesoprod, descricaoprod, fk_codcategoria) VALUES (:nomeprod, :precoprod, :tamanhoprod, :pesoprod, :descricaoprod, :fk_codcategorias)";
