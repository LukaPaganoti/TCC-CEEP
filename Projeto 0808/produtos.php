...
<head>
    ...
    <style>
        ...
        .form-group {
            display: flex;
            align-items: center;
            margin-right: 20px; /* Adiciona margem entre a barra de pesquisa e os ícones */
        }
        ...
        #cart-icon {
            width: 30px;
            height: 30px;
            margin-left: 40px; /* Aumenta a margem à esquerda para afastar os ícones */
        }
        ...
        #profile-img {
            ...
            height: 30px;
            cursor: pointer;
            margin-left: 20px; /* Aumenta a margem à esquerda para afastar os ícones */
        }
        ...
        .search-box {
            text-align: center;
            margin-top: 20px; /* Ajusta a margem no topo para alinhar no meio da página */
        }
    ...
    <header>
        <div class="container">
            ...
            <div class="icons">
                ...
                <a href="#"><img src="imagens-de-carrinho-de-compras-png-4.png" alt="Carrinho" id="cart-icon"></a>
