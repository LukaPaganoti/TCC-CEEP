...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    $emailcli = filter_var ($_POST['emailcli'],
FILTER_SANITIZE_EMAIL);
    $senhacli = md5($_POST['senhacli']);

    $stmt = $pdo ->prepare("SELECT * FROM tb_clientes WHERE emailcli = :emailcli AND senha = :senha");
    ...
    $usuariocli['codcli'];
        ...
        if ($usuariocli['tipocadastro'] === 'A'){
            ...
            header("Localhost: telainicial.php");
            exit();
        }
    } else {
