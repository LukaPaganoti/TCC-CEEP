...
$sql = "SELECT * FROM tb_imagens_prod WHERE codimagem = :cod";
...
$stmtc->execute();
$produtos = $stmtc->fetchAll(PDO::FETCH_ASSOC);
...
<body>
    ...
    <form method="POST" name="produtosform">
        <div class="form-group">
            ...
            <option value="<?php echo $produto['codproduto']; ?>"><?php echo $produto['nomeprod']; ?></option>
            <?php } ?>
            </select>
            <br>
...
<?php
    if (isset($_POST['btnAlterar'])) {
        $produtoimg = $_POST['img_editada'];
        $fk_codproduto = $_POST['fk_codproduto'];
        $codimagem = $_GET['cod']; // Certifique-se de obter o código da imagem corretamente
    
        $sqlup = "UPDATE tb_imagens_prod SET produtoimg = :produtoimg, fk_codproduto = :fk_codproduto WHERE codimagem = :codimagem";
