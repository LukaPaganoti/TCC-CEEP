...
// Calcular o total
$total = 0;
foreach ($_SESSION['produto_prod'] as $codproduto => $quantidade) {
    // Substitua com os valores reais do seu array $_SESSION['produto_prod']
    $preco = 10; // Exemplo, substitua pelo preço real do produto
