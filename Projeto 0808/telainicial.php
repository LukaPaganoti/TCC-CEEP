...
if ($stmt !== null && $stmt->execute()) {
    ...
    if (count($resultados) > 0) {
        ...
        foreach ($resultados as $produto) {
            echo "<li>Nome: {$produto['nomeprod']} - Preço: R$ " . number_format($produto['precoprod'], 2, ',', '.');
            if (!empty($produto['produtoimg'])) {
                echo "<img src='{$produto['produtoimg']}' alt='Imagem do Produto' width='150px' height='150px'>";
            }
            echo "</li>";
        }
        echo "</ul>";
            ...
            <?php foreach ($produtos as $produto) : ?>
                <div class="product">
                    <?php if (!empty($produto['produtoimg'])) : ?>
                        <img src="<?php echo $produto['produtoimg']; ?>" alt="Imagem do Produto" width="150px" height="150px">
                    <?php endif; ?>
