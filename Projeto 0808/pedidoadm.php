...
<body>
    <form method="post" class="form-group" enctype="multipart/form-data">
        ...
        <input type="text" name="codtransporte" value="<?php if (isset($pedido)) echo $pedido['codtransporte']; ?>">
        <br><br>
        <label>Tipo de pedido</label>
        <select name="tipoped" required>
            <option value="1" <?php if (isset($pedido) && $pedido['tipoped'] == 1) echo 'selected'; ?>>A opção pix não está disponivel no momento</option>
