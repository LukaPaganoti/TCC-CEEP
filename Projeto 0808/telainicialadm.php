        ...
        <div class="container">
            ...
            <div class="product-container">
                <div class="product">
                    ...
                    <p>R$ 70,00</p>
                    <<td><a href="alterarproduto.php?cod=<?php echo $r['codproduto'] ?>" class="btn btn-warning"> Alterar</a> 
                - <a href="excluirproduto.php?cod=<?php echo $r['codproduto'] ?>" class="btn btn-danger">Excluir</a> </td>
            </tr>
                </div>
                <div class="product">
